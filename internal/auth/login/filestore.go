...
func (s *FileTokenStore) List(ctx context.Context) ([]*provider.Auth, error) {
...
func (s *FileTokenStore) readAuthFile(path, baseDir string) (*provider.Auth, error) {
...
func (s *FileTokenStore) resolveAuthPath(auth *provider.Auth) (string, error) {
	if auth == nil {
		return "", fmt.Errorf("auth filestore: auth is nil")
	}
	if auth.Attributes != nil {
